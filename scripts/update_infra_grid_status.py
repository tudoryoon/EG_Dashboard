...
FRED_EQUIPMENT_SERIES = {
    "power_specialty_transformer_ppi": {
        ...
        "subtitle": "Producer Price Index for electric power and specialty transformer manufacturing, power and distribution transformers except parts. Monthly, indexed by BLS/FRED using the latest FRED vintage.",
        "color": "#111827",
        "yAxisLabel": "Index",
        "formatter": "number1",
    },
    ...
    "power_distribution_transformer_ppi": {
        ...
        "subtitle": "Commodity PPI for power and distribution transformers, except parts. Monthly, indexed by BLS/FRED using the latest FRED vintage.",
        "color": "#7c3aed",
        "yAxisLabel": "Index",
        "formatter": "number1",
    },
